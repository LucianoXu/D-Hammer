...
namespace dhammer {
    ...
    // The rewriting rules of the D-Hammer kernel.
    using PosRewritingRule = std::optional<ualg::TermPtr<int>> (*)(Kernel& kernel, ualg::TermPtr<int> term);

#define DHAMMER_RULE_DEF(name, kernel, term) std::optional<ualg::TermPtr<int>> name(dhammer::Kernel& kernel, ualg::TermPtr<int> term)
