...
TEST(DiraceReduction, variable_expand_K) {
    Kernel kernel;
...
TEST(DiraceReduction, variable_expand_K_apply) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("A"), kernel.parse("INDEX"));
...
TEST(DiraceReduction, variable_expand_B) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("A"), kernel.parse("INDEX"));
...
TEST(DiraceReduction, variable_expand_O) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("A"), kernel.parse("INDEX"));
...
TEST(DiraceReduction, wolfram_fullsimplify) {
...
TEST(DiraceReduction, R_COMPO_SS) {
    Kernel kernel;
...
TEST(DiraceReduction, R_COMPO_SK) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("a"), kernel.parse("STYPE"));
    kernel.assum(kernel.register_symbol("K"), kernel.parse("KTYPE[T]"));
...
TEST(DiraceReduction, R_COMPO_SB) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("a"), kernel.parse("STYPE"));
...
TEST(DiraceReduction, R_COMPO_SO) {
    Kernel kernel;
...
TEST(DiraceReduction, R_COMPO_KS) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("a"), kernel.parse("STYPE"));
    kernel.assum(kernel.register_symbol("K"), kernel.parse("KTYPE[T]"));
...
TEST(DiraceReduction, R_COMPO_KK) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T1"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("T2"), kernel.parse("INDEX"));
...
TEST(DiraceReduction, R_COMPO_KB) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T1"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("T2"), kernel.parse("INDEX"));
...
TEST(DiraceReduction, R_COMPO_BS) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("B"), kernel.parse("BTYPE[T]"));
    kernel.assum(kernel.register_symbol("a"), kernel.parse("STYPE"));
...
TEST(DiraceReduction, R_COMPO_BK) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("B"), kernel.parse("BTYPE[T]"));
    kernel.assum(kernel.register_symbol("K"), kernel.parse("KTYPE[T]"));
...
TEST(DiraceReduction, R_COMPO_BB) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T1"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("T2"), kernel.parse("INDEX"));
...
TEST(DiraceReduction, R_COMPO_BO) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T1"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("T2"), kernel.parse("INDEX"));
...
TEST(DiraceReduction, R_COMPO_OS) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T1"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("T2"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("O"), kernel.parse("OTYPE[T1, T2]"));
...
TEST(DiraceReduction, R_COMPO_OK) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T1"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("T2"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("O"), kernel.parse("OTYPE[T1, T2]"));
...
TEST(DiraceReduction, R_COMPO_OO) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T1"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("T2"), kernel.parse("INDEX"));
...
TEST(DiraceReduction, R_COMPO_DD) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T1"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("T2"), kernel.parse("INDEX"));
...
TEST(DiraceReduction, R_COMPO_ARROW) {
    Kernel kernel;
...
TEST(DiraceReduction, R_COMPO_FORALL) {
    Kernel kernel;
...
TEST(DiraceReduction, R_STAR_PROD) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T"), kernel.parse("INDEX"));
    TEST_RULE(kernel, {R_STAR_PROD}, "STAR[T, T]", "PROD[T, T]");
}

TEST(DiraceReduction, R_STAR_MULS) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("a"), kernel.parse("STYPE"));
    kernel.assum(kernel.register_symbol("b"), kernel.parse("STYPE"));
...
TEST(DiraceReduction, R_STAR_TSRO) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T1"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("T2"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("T3"), kernel.parse("INDEX"));
...
TEST(DiraceReduction, R_STAR_CATPROD) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T1"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("T2"), kernel.parse("INDEX"));
...
TEST(DiraceReduction, R_STAR_LTSR) {
    Kernel kernel;
...
TEST(DiraceReduction, R_ADDG_ADDS) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("a"), kernel.parse("STYPE"));
    kernel.assum(kernel.register_symbol("b"), kernel.parse("STYPE"));
...
TEST(DiraceReduction, R_ADDG_ADD) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T1"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("K1"), kernel.parse("KTYPE[T1]"));
...
TEST(DiraceReduction, R_BETA_ARROW) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T"), kernel.parse("TYPE"));
...
TEST(DiraceReduction, R_BETA_INDEX) {
    Kernel kernel;
...
TEST(DiraceReduction, R_FLATTEN) {
...
TEST(DiraceReduction, R_MULS0) {
    TEST_RULE({R_MULSID, R_MULS0}, "Times[0, a, b]", "0");
}

TEST(DiraceReduction, R_MULS1) {
...
TEST(DiraceReduction, R_SCRK1) {
    TEST_RULE({R_SCRK1}, "SCR[a, 0K[T]]", "0K[T]");
}

TEST(DiraceReduction, R_SCRB0) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("B"), kernel.parse("BTYPE[T]"));
...
TEST(DiraceReduction, R_SCRB1) {
    TEST_RULE({R_SCRB1}, "SCR[a, 0B[T]]", "0B[T]");
}

TEST(DiraceReduction, R_SCRO0) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T1"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("T2"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("O"), kernel.parse("OTYPE[T1, T2]"));
...
TEST(DiraceReduction, R_TSRK2) {
    TEST_RULE({R_TSRK2}, "TSR[KET[s], KET[t]]", "KET[PAIR[s, t]]");
}

TEST(DiraceReduction, R_TSRB0) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T1"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("T2"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("B"), kernel.parse("BTYPE[T2]"));
...
TEST(DiraceReduction, R_TSRB2) {
    TEST_RULE({R_TSRB2}, "TSR[BRA[s], BRA[t]]", "BRA[PAIR[s, t]]");
}

TEST(DiraceReduction, R_TSRO0) {
    Kernel kernel;
    kernel.assum(kernel.register_symbol("T1"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("T2"), kernel.parse("INDEX"));
    kernel.assum(kernel.register_symbol("T3"), kernel.parse("INDEX"));
...
TEST(DiraceReduction, R_SUM_ELIM1) {
...
TEST(DiraceReduction, R_SUM_ELIM2) {
...
TEST(DiraceReduction, R_SUM_ELIM3) {
...
TEST(DiraceReduction, R_SUM_ELIM4) {
...
TEST(DiraceReduction, R_SUM_ELIM5) {
...
TEST(DiraceReduction, R_SUM_ELIM6) {
...
TEST(DiraceReduction, R_SUM_ELIM7) {
...
TEST(DiraceReduction, R_SUM_PUSH0) {
...
TEST(DiraceReduction, R_SUM_INDEX0) {
...
TEST(DiraceReduction, R_SUM_INDEX1) {
...
TEST(DiraceReduction, R_LABEL_EXPAND_B) {
    Kernel kernel;
...
TEST(DiraceReduction, R_LABEL_EXPAND_O) {
    Kernel kernel;
...
// // (a + (b * 0))^* -> 0
// TEST(DiraceReduction, Combined1) {
//     TEST_RULE(rules, "Conjugate(Plus(a Times(b 0)))", "Conjugate(a)");
// }

// // (b * 0)^*^* -> 0
// TEST(DiraceReduction, Combined2) {
