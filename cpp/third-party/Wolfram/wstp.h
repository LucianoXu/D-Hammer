/*************************************************************************
        ...
        Copyright 1986 through 2022 by Wolfram Research Inc.
        All rights reserved
...
#if WSVERSION != 6 || WSINTERFACE != 4
#error "This header file only works with WSVERSION=6, WSINTERFACE=4"
#endif

#define WSREVISION 48
#define WSMATHVERSION 13.2.0
...
#define WSOLDDEFINITION WSAPI4REVISION /* WSAPI4 is as old as it gets */
...
#define MLREADYPARALLELENV WSREADYPARALLELENV
...
#define MLREVISION 48
#define MLMATHVERSION 13.2.0
...
typedef WSStringPosition * WSStringPositionPointer;
...
typedef WSOldStringPosition * WSOldStringPositionPointer;
...
extern int WSMain(int, char **); /* pass in argc and argv */
extern int WSMainString( char *commandline);
extern int WSMainArgv( char** argv, char** argv_end); /* note not FAR pointers */

extern int WSInstall(WSLINK);
extern wsapi_packet WSAnswer(WSLINK);
